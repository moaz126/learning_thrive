...
//for stay login
  ...
  void readLocal() {
    /* if (authProvider.getUserFirebaseId()?.isNotEmpty == true) {
      currentUserId = loggedInUser.uid as String;
    } else {
    ...
    //String currentId = ${loggedInUser.uid};
    final String current =  loggedInUser.uid as String;
    print('${loggedInUser.uid}' + ' output hay///////////////////////////////////////////////////////');
    String peerId = widget.arguments.peerId;
    groupChatId = '$current-$peerId';
    /* if ((loggedInUser.uid as String).compareTo(peerId) > 0) {
