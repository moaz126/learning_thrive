...
class showStudentforLecture extends StatefulWidget {
  showStudentforLecture({Key? key}) : super(key: key);

  @override
  State createState() => showStudentforLectureState();
}

class showStudentforLectureState extends State<showStudentforLecture> {
  showStudentforLectureState({Key? key});
          ...
          child: TextButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => uploadfile(arguments: 
                  lectureArguments(
                      peerId: userChat.uid,
